...
class GeminiClient(private val apiKey: String) {
    ...
    private val systemPrompt = """
        ...
        The user may speak in English, Hindi, or a Hindi-English mix (Hinglish) — understand
        both and always respond with the same JSON schema regardless of input language.
